...
require __DIR__."/../../Classes/config/Settings/FaqCate.php";
use Manage\manage;
$mng = new manage;
...
if(!empty($_POST)){
  ...
  if($_POST["mode"] == "search"){
    ...
    $sql = "SELECT code,title,icon from $table";
    #echo $sql."\n";
...
$smarty->assign("actionVal", "Settings/FaqCate");
...
$smarty->display('Settings/FaqCate.tpl');