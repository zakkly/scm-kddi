{if !empty($r)}
  ...
  <tr class="dataObj" data-code="{$v["code"]}">
    ...
    <td class="stocktotal num">{$v["stock"]+$v["stock2"]+$v["stock3"]+$v["stock4"]}</td>
    <td class="stock3 num">{$v["stock3"]}</td>
    <td class="stock2 num">{$v["stock2"]}</td>
    <td class="stock1 num">{$v["stock"]}</td>
    <td class="stock4 num">{$v["stock4"]}</td>
